...
u_stat, p_value = stats.mannwhitneyu(group_A['VALUE'], group_B['VALUE'])
print(f'U-statistic: {u_stat}')
print(f'P-value: {p_value}')
print(f'Average value for group A: {group_A["VALUE"].mean()}')
print(f'Average value for group B: {group_B["VALUE"].mean()}')
