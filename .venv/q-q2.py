...
column_rate = np.diff(np.log(filtered_df_rate['VALUE'][filtered_df_rate['VALUE']>0]))
...
column_counts = np.diff(np.log(filtered_df_counts['VALUE'][filtered_df_counts['VALUE']>0]))
